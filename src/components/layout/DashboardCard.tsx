...
export const DashboardCard = ({ title, value, subtitle, icon, trend, alert }: DashboardCardProps) => {
  return (
    <div className={`bg-white rounded-lg shadow-sm border ${alert ? 'border-red-300' : 'border-gray-200'} p-6`}>
